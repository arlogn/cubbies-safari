...
var Cubbies = {
  ...
  appendCSS: function(){
    ...
    stylesheet.innerHTML = "" +
      ...
      ".cubbies-selected{ z-index: 9999; -webkit-box-shadow: 3px 3px 8px -1px blue !important; cursor: pointer !important; margin: -3px 3px 3px -3px; }\n" +
      ".cubbies-selected:active{ -webkit-box-shadow: 2px 2px 5px -1px darkblue !important; margin: -1px 1px 1px -1px; }\n" +
